...
TipBox.prototype.renderUI = function(tipType){
    ...
    if(this.config.hasBtn){
        ...
        switch(this.config.type){
            case 'success':$(".success").after("<p style='text-align:center;'><button class='okoButton' >Ok</button></p>");
                break;
            case 'error':$(".lose").after("<button class='okoButton redOkoButton'></button>");
                break;
